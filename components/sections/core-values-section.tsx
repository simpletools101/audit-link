            ...
            <div className="container mt-12 mb-14">
                ...
                <div className="flex items-center justify-center mb-8">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        <span className="text-[#071A44]">Our</span>{' '}
                        <span className="text-[#00A8B5]">Core Values</span>
                    </motion.h2>
                </div>

                {/* Grid */}
                <div className="grid mt-12 gap-8 md:grid-cols-2 lg:grid-cols-4 items-stretch">
                    {coreValues.map((value, index) => (
                        ...
                        >
                            <Card
                                ...
                                "
                            >
                                <CardContent className="p-8 text-center flex flex-col gap-6 h-full">
                                    {/* Icon */}
                                    ...
                                    {/* Title – locked height for alignment */}
                                    <h3 className="text-xl font-bold tracking-tight text-[#00A8B5] min-h-[56px] flex items-center justify-center">
                                        {value.title}
                                    </h3>
